                    ...
                    <form class="form-horizontal" action="{{url('/brand/new')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                               ...
                               <span class="text-red">{{ $errors->has('brand_name') ? $errors->first('brand_name') : '' }}</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="category_discription"  class="col-sm-2 control-label">Brand Discription</label>
                            <div class="col-sm-10" >
                                <textarea class="form-control" rows="4" name="brand_discription" placeholder="Brand Discription" id="summernote"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
